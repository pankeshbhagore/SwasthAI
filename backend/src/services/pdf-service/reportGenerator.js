/**
 * SwasthAI Ultra-Premium Health Report PDF Generator
...
const generateHealthReport = async (user, options = {}) => {
  try {
    ...
    const filename = `swasthai_health_report_${user._id}_${Date.now()}.pdf`;
    ...
    return new Promise((resolve, reject) => {
      ...
      doc.fillColor("#00e5ff").fontSize(32).font("Helvetica-Bold").text("SwasthAI", 50, 40);
      ...
      for (let i = 0; i < pages.count; i++) {
        ...
        doc.fillColor("#999").fontSize(8).font("Helvetica")
           .text(
             "⚠️ DISCLAIMER: This report is generated by SwasthAI for informational purposes only. It is not a clinical diagnosis or medical prescription. Please consult a licensed medical professional for formal medical advice and treatment.",
