...
TRAINING_DATA = [
    ...
    ("chest pain shortness of breath sweating arm pain nausea", "Cardiac Emergency", "EMERGENCY"),
    ("chest pain radiating jaw pain nausea vomiting sweating", "Heart Attack", "EMERGENCY"),
    ("difficulty breathing wheezing chest tightness gasping", "Respiratory Emergency", "EMERGENCY"),
    ("sudden severe headache neck stiffness fever vomiting light sensitivity", "Meningitis", "EMERGENCY"),
    ("facial drooping arm weakness speech difficulty confusion", "Stroke", "EMERGENCY"),
    ("seizure convulsion unconscious tongue biting", "Seizure Disorder", "EMERGENCY"),
    ("severe allergic reaction hives throat swelling difficulty swallowing", "Anaphylaxis", "EMERGENCY"),
    ("high fever chills body aches severe fatigue confusion", "Severe Flu/Sepsis", "EMERGENCY"),
    ("abdominal pain rigid abdomen vomiting blood", "Acute Abdomen", "EMERGENCY"),
    ("heavy bleeding uncontrolled trauma", "Hemorrhage", "EMERGENCY"),
    ("poisoning vomiting unconscious pupils dilated", "Toxic Ingestion", "EMERGENCY"),
    ("heat stroke high temp no sweating confusion", "Heat Stroke", "EMERGENCY"),
    ("crushing chest pain pressure heavy weight on chest left arm numbness", "Cardiac Emergency", "EMERGENCY"),
    ("blue lips gasping for air unable to speak respiratory distress", "Respiratory Emergency", "EMERGENCY"),

    ("fever headache muscle ache fatigue cough sore throat", "Influenza", "MODERATE"),
    ("high fever chills sweating joint pain back pain", "Malaria", "MODERATE"),
    ("fever rash joint pain eye pain muscle pain", "Dengue Fever", "MODERATE"),
    ("high fever vomiting diarrhea stomach pain headache", "Typhoid", "MODERATE"),
    ("severe headache nausea vomiting light sensitivity aura", "Migraine", "MODERATE"),
    ("chest pain breathing difficulty fever cough yellow mucus", "Pneumonia", "MODERATE"),
    ("abdominal pain nausea vomiting loss of appetite right side pain", "Appendicitis", "MODERATE"),
    ("painful urination burning frequent urination fever back pain", "UTI", "MODERATE"),
    ("high blood pressure headache dizziness blurred vision", "Hypertensive Crisis", "MODERATE"),
    ("blood sugar high thirst frequent urination weight loss sweet breath", "Diabetic Episode", "MODERATE"),
    ("skin rash itching redness swelling blisters", "Allergic Reaction", "MODERATE"),
    ("severe back pain radiating leg pain numbness", "Disc Problem", "MODERATE"),
    ("vomiting diarrhea stomach cramps dehydration", "Gastroenteritis", "MODERATE"),
    ("yellow skin jaundice fatigue dark urine pale stool", "Jaundice/Hepatitis", "MODERATE"),
    ("chronic cough weight loss night sweats blood in sputum", "Tuberculosis", "MODERATE"),
    ("intense itching between fingers night itching", "Scabies", "MODERATE"),

    ("runny nose sneezing mild cough sore throat watery eyes", "Common Cold", "MILD"),
    ("low fever mild headache body ache", "Viral Fever", "MILD"),
    ("cough mucus sore throat chest congestion", "Bronchitis", "MILD"),
    ("stomach ache bloating gas acidity", "Indigestion", "MILD"),
    ("diarrhea mild stomach cramps nausea", "Mild Gastritis", "MILD"),
    ("mild rash itching redness", "Mild Allergy", "MILD"),
    ("mild headache fatigue stress", "Tension Headache", "MILD"),
    ("ear pain ear discharge hearing loss", "Ear Infection", "MILD"),
    ("eye redness discharge itching burning", "Conjunctivitis", "MILD"),
    ("toothache gum pain swelling", "Dental Problem", "MILD"),
    ("skin dry flaky itchy redness", "Dermatitis", "MILD"),
    ("mild back pain stiffness muscle pull", "Muscle Strain", "MILD"),
    ("constipation bloating hard stools", "Constipation", "MILD"),
    ("nasal congestion sneezing itchy nose", "Allergic Rhinitis", "MILD"),
    ("mild dizziness lightheadedness", "Mild Vertigo", "MILD"),
    ("fatigue weakness tiredness pale skin", "Fatigue/Anemia", "MILD"),
    ("sore muscles after exercise", "DOMS", "MILD"),
    ("heartburn acid reflux chest discomfort after eating", "GERD", "MILD"),
    ("mouth ulcers painful spots", "Mouth Ulcer", "MILD"),
    ("hair loss dandruff scalp itch", "Scalp Issue", "MILD"),
    ("insomnia difficulty sleeping", "Sleep Issue", "MILD"),
    ("mild anxiety worry", "Anxiety", "MILD"),
]
...
VITALS_TRAINING = [
    ...
    [55, 160, 105, 110, 180, 33, 39.2, 80],
    [42, 145, 95, 85, 115, 29, 37.8, 40],
    [29, 122, 81, 72, 92, 23, 37.0, 11],
    [62, 165, 98, 92, 160, 31, 38.2, 65],
    [18, 110, 70, 60, 80, 19, 36.6, 5],
]
...
class MediMindMLService:
    ...
    def train(self):
        ...
        print(f"  OK Symptom classifier: {len(set(diseases))} diseases, {len(texts)} samples")
        ...
        print(f"  OK Vitals risk model trained")
